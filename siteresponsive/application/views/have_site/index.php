		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="col-md-4"><img src="<?php echo base_url();?>assets/images/responsive.svg" alt="Responsive"/></div><div class="col-md-8"><h2>Get a free Responsive<br/>Tool Report</h2></div>
				...
				<div class="col-md-6">
					<div class="box-container">
					<div class="col-md-12">
						<div class="col-md-4"><img src="<?php echo base_url();?>assets/images/rocket.svg" alt="Seo"/></div><div class="col-md-8"><h2>Get a free SEO Report</h2></div>
