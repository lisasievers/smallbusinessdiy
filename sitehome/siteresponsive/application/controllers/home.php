    ...
    function _mail_sender($from = '', $to = '', $subject = '', $message = '', $mask = "", $html = 0, $smtp = 1)
    {
       // echo 'mail'.$message;exit;
        ...
        {     
            ...
            $filename='report';
            $site_url=base_url();
            $attched_file = $_SERVER["DOCUMENT_ROOT"].'/sitehome/sitedoctor/'.$message;
...
/* function havesite(){
   // $data['body'] = 'have_site/page_details';
    ...
    $this->load->view('have_site/header', $data);
    $this->load->view('have_site/page_details');
    $this->load->view('have_site/footer');
...
function havesite($base_site=""){
  ...
  //  $this->load->view('have_site/header', $data);
    //$this->load->view('have_site/page_responsive');
    //$this->load->view('have_site/footer');
