  ...
  $(function() {
      $('#users-table').DataTable({
          ...
          "fnRowCallback": function( Row, data, iDisplayIndex ) {
                ...
                {
                  $('td:eq(7)', Row).html('<a href="createsite/'+data.id+'" target="_blank" title="Create"><i class="fa fa-cog fa-spin fa-fw"></i> <a href="javascript:showitem('+data.id+')" title="Download"><i class="fa fa-file-text fa-2x" aria-hidden="true"></i></a> ');
                return Row;
                }
            },  
      });
