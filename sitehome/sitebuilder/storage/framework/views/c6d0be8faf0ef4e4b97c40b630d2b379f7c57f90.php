...
-->
  <form role="form" id="sign_form" method="post" action="<?php echo e(route('image.upload.ajax')); ?>" enctype="multipart/form-data">
...
<div class="form-group">
            ...
            <input type="hidden" class="form-control site_url" value="<?php echo e($cdata[1]); ?>/sitebuilder/public/" />
          </div>
          <div class="form-group">
...
<input type="radio" class="" id="pay_adjust" name="whodo" value="youwill" style="margin-left:50px;margin-right:10px;" required=""><label for="pay_adjust"> <span class="diy-color">DO IT</span> for me</label>
           ...
           <input type="hidden" name="_token" class="token" value="<?php echo e(Session::token()); ?>">
          <div class="form-group-footer">
    ...
    <div class=" setup-content" id="step-3">
      <div class="col-xss-6">
        ...
        <!--payment section -->
          ...
          <div class="cost-data">
          <table class="table" style="width:60%"><tr><td>Inital Basic cost</td><td>$<?php echo e($data['doit_cost']); ?></td></tr><tr><td>Setup cost</td><td>$<?php echo e($data['setup_cost']); ?></td></tr><tr><td>Total cost</td><td>$<?php echo e($data['doit_cost']+$data['setup_cost']); ?></td></tr></table>
          <input type="hidden" class="doitcost" value="<?php echo e($data['doit_cost']+$data['setup_cost']); ?>" />
