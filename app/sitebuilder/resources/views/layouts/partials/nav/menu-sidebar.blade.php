...
<?php } if(Request::path() !=  'userwebsite') { //$data['page']='';  ?> 
        ...
        <li class="<?php if($page=='Website Addition'){ echo 'active'; } ?>">
            <a id="addsite" href="{{ route('user-reports-addition') }}"><i class="fa fa-plus-square" aria-hidden="true"></i> Add Website for reports</a>
            
        </li>
        <li class="<?php if($page=='Reports Tools'){ echo 'active'; } ?>">
            <a id="reportstools" href="{{ route('user.showreports') }}"><i class="fa fa-cogs" aria-hidden="true"></i> Reports Tools</a>
            <ul class="treeview-menu">
              <li><a href="{{ route('user.freereports') }}"> <i class="fa fa-snowflake-o" aria-hidden="true"></i> FREE</a></li>   
              <li><a href="{{ route('user.paidreports') }}"><i class="fa fa-superpowers" aria-hidden="true"></i> PAID</a></li>    
             </ul> 
        </li>
        <li class="<?php if($page=='Reports Tools'){ echo 'active'; } ?>">
            <a id="reportstools" href="{{ route('user.showreports') }}"><i class="fa fa-cogs" aria-hidden="true"></i> Settings</a>
        ...
        <li class="<?php if($data['page']=='Email Job'){ echo 'active'; } ?>">
         ...
         <li class="<?php if($page=='Reports Tools'){ echo 'active'; } ?>">
            <a id="reportstools" href="{{ route('user.showreports') }}"><i class="fa fa-users" aria-hidden="true"></i> User Settings</a>
            
        </li> 
        <li class="<?php if($page=='Reports Tools'){ echo 'active'; } ?>">
            <a id="reportstools" href="{{ route('user.showreports') }}"><i class="fa fa-envelope" aria-hidden="true"></i> Email Marketing</a>
