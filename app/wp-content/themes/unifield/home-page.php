...
transform: translate3d(0,0,0) !important;
 ...
 <div class="main-text">
                <div class="col-md-12 text-center">
                    ...
                    <div class="diy-call">
                        <div class="one_half"><div class="iter1"><span class="diy-color">NEED</span> A WEBSITE </div><div class="iter2"><a class="btn-learn" href="<?php echo esc_url() ; ?>sitebuilder/public/signup">LEARN MORE <i class="fa fa-caret-right" aria-hidden="true"></i></a></div></div>
                        <div class="one_half"><div class="iter1"><span class="diy-color">HAVE</span> A WEBSITE </div><div class="iter2"><a class="btn-learn" href="<?php echo esc_url() ; ?>siteresponsive/home/havesite">LEARN MORE <i class="fa fa-caret-right" aria-hidden="true"></i></a></div></div>
